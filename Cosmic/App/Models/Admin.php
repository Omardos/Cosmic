   ...
   public static function offerEdit($id, $currencys, $amount, $price, $offer_id, $private_key)
   {
    ...
    public static function editValueById($value_id, $cost_points, $cost_credits, $points_type, $club_only)
    {
         $data = array(
          ...
          return QueryBuilder::table('catalog_items')->where('id', $value_id)->update($data);
    }
    ...
    public static function editJob($jobid, $job_title, $small_description, $full_description)
    {
        ...
        return QueryBuilder::table('website_jobs')->where('id', $jobid)->update($data);
    }
    ...
    public static function addJob($job_title, $small_description, $full_description)
    {
        ...
        return QueryBuilder::table('website_jobs')->insert($data);
    }
  
    public static function deleteJob($id)
    {
        return QueryBuilder::table('website_jobs')->where('id', $id)->delete();
    }
