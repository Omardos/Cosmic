...
class Apply
{
    ...
    public function request()
    {
        ...
        Community::addJobApply($job_id, $player_id, Core::filterString($firstname), Core::filterString($message), $available_monday, $available_tuesday, $available_wednesday, $available_thursday, $available_friday,$available_saturday, $available_sunday);
